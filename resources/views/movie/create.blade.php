<x-app-layout>
    ...
    <form id="createForm" method="POST" action="{{ url('/save')}}" class="w-3/4 mx-auto mt-4"> 
        ...
        <div class="relative w-1/2 mx-auto">
            <input type="search" v-model="searchText" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-r-lg border-l-gray-100 border-l-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Search">
