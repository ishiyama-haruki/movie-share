            ...
            <table class="w-full text-left text-gray-500 dark:text-gray-400">
                <thead class="text-gray-700 bg-gray-200 dark:bg-gray-700 dark:text-gray-500">
                    <tr>
                        ...
                        <th scope="col" class="leading-10">平均評価</th>
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        @endif
                        <td class="align-middle pl-1"><a href="{{ route('movieDetail', ['id' => $movie->id]) }}" class="font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline">{{ $movie->title }}</a></td>
                        <td>
