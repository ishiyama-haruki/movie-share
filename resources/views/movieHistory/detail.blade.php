        ...
        @if (Auth::id() == $movieHistory->user_id || $movieHistory->accessible)
                    ...
                    <div class="flex flex-col justify-between p-4 leading-normal">
                        ...
                        <div class="flex w-full justify-between mt-2">
                            ...
                            <div class="w-1/4">
                                ...
                                <input type="number" name="viewing_count" value="{{ $movieHistory->viewing_count }}" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"></input>
                            </div>
                        </div>
                        <label for="" class="block mt-2 text-sm font-medium text-gray-900 dark:text-white">感想</label>
                        <textarea name="impression" value="{{ $movieHistory->impression }}" required rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ $movieHistory->impression }}</textarea>
                        <div class="mt-4 flex justify-end">
                            <button type="submit" formmethod="POST" formaction="{{ route('historyUpdate', $movieHistory->id) }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">更新</button>
                            <button type="submit" formmethod="GET" formaction="{{ route('historyDelete', $movieHistory->id) }}" class="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">削除</button>
                        </div>
                    </div>
                </div>
            </form>
                        ...
                        <div class="flex flex-col justify-between py-4 md:px-8 px-4 leading-normal">
                            ...
                            <div class="flex w-full justify-between mt-3 md:flex-nowrap flex-wrap">
                                ...
                                <div class="md:w-1/6 w-1/3">
                                    ...
                                    <p class="mb-3 font-normal text-center text-gray-700 dark:text-gray-400">{{ $movieHistory->viewing_count }}回</p>
                                </div>
                                <div class="md:w-1/6 w-1/3">
            ...
            <div class=" mt-14 border border-gray-200 rounded-lg shadow max-h-176 overflow-y-auto">
                                ...
                                @foreach($movieHistory->comments()->get() as $comment)
                                    <tr class="border-b dark:bg-gray-800 dark:border-gray-700">
                                        <td class="md:p-2 p-1 md:w-auto w-1/4">
                                            <a href="{{ route('profile', ['id' => $comment->user->id]) }}" class="font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline">{{ $comment->user->name }}</a>
                                        </td>
                                        ...
                                        <td class="md:w-1/12 w-1/6 md:p-2 p-1 text-right">
                                            @if ($comment->user->id == Auth::id())
                                                <button type="submit" formaction="{{ route('commentDelete', ['id' => $comment->id ]) }}" class="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm md:px-5 px-2 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">削除</button>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
                ...
                <form action="{{ route('commentStore') }}" method="POST" class="flex items-center justify-between m-2">
                    ...
                    <textarea type="text" col=2 name="message" required class="w-2/3 mr-5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="コメントを投稿する"></textarea>
